...
/***/ (function(module, exports, __webpack_require__) {
	...
	$app_define$('@app-component/specialbook', [], function($app_require$, $app_exports$, $app_module$){
	     $app_script$($app_module$, $app_exports$, $app_require$)
	     if ($app_exports$.__esModule && $app_exports$.default) {
	            $app_module$.exports = $app_exports$.default
	        }
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          "type": "text",
	          "attr": {
	            "value": function () {return this.bookinfo.intro}
	          },
	          "classList": [
	            "book-intro"
	          ]
	        },
	        {
	          "type": "text",
	          "attr": {
	            "value": function () {return (this.bookinfo.price) + '悠空币'}
	          },
	          "classList": [
	            "origin-price"
	          ]
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              "type": "text",
	              "attr": {
	                "value": function () {return this.bookinfo.specialPrice}
	              },
	              "classList": [
	                "special-price"
	              ]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    refresh: function refresh() {
	        ...
	        this.page = 1;
	        _bookData2.default.specialBook({ pageSize: 10, pageIndex: this.page }).then(function (res) {
	            _this.bookList = [];
