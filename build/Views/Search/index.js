...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $app_template$ = __webpack_require__(117)
	var $app_style$ = __webpack_require__(118)
	var $app_script$ = __webpack_require__(119)
	...
	module.exports = {
	  ...
	  "children": [
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "style": {
	                "opacity": function () {return this.showEmpty?'1':'0'}
	              }
	            }
	          ]
	        },
	    ...
	    },
	    {
	      ...
	      "shown": function () {return !this.isSeach},
	      "children": [
	        {
	          "type": "div",
	          "attr": {},
	              ...
	              "children": [
	                {
	                  ...
	                  "repeat": {
	                    "exp": function () {return this.searchHot},
	                    "value": "item"
	                  },
	                  "events": {
	                    "click": function (evt) {this.hotsearch(this.item,evt)}
	                  },
	                  "children": [
	                    {
	                      "type": "text",
	              ...
	              "children": [
	                {
	                  ...
	                  "repeat": {
	                    "exp": function () {return this.allBooklist},
	                    "value": "item"
	                  }
	                }
	              ]
	          ...
	          "children": [
	            {
	              "type": "div",
	              "attr": {},
	              "classList": function () {return [this.type==0?'active':'']},
	              "events": {
	                "click": function (evt) {this.showContent(0,evt)}
	              },
	              "children": [
	                {
	                  "type": "text",
	                  ...
	                  "classList": function () {return [this.type==0?'selected':'']}
	                }
	              ]
	            },
	            {
	              "type": "div",
	              "attr": {},
	              "classList": function () {return [this.type==1?'active':'']},
	              "events": {
	              ...
	              "children": [
	                {
	                  ...
	                  "classList": function () {return [this.type==1?'selected':'']}
	                }
	              ]
	            },
	            {
	              ...
	              "children": [
	                {
	                  ...
	                  "classList": function () {return [this.type==2?'selected':'']}
	                }
	              ]
	            }
	          ]
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {},
	                      "repeat": {
	                        "exp": function () {return this.resultData},
	                        "value": "item"
	                      },
	                      "children": [
	                        {
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": "../../Common/imgs/no-search-result.png"
	                  }
	                },
	                {
	                  "type": "text",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: (_data = {
	        ...
	        searchValue: '',
	        isSeach: false,
	        resultData: [] }, _defineProperty(_data, 'page', 1), _defineProperty(_data, 'hasMoreData', true), _defineProperty(_data, 'hasResult', true), _defineProperty(_data, 'tabTitle', ["全部", "书名", "作者"]), _data),
	    onInit: function onInit() {
	        this.getSearch();
	    },
	    ...
	    search: function search() {
	        ...
	        this.hasResult = true;
	        _bookData2.default.search({ pageSize: 10, pageIndex: this.page, content: this.searchValue || '最强村医', type: this.type }).then(function (res) {
	            var result = res.data;
	            if (result.length < 10) {
	            ...
	            _this.$element("search-input").focus({
	                focus: false
	            });
	        });
	    },
	    searchLoad: function searchLoad() {
	        ...
	        _bookData2.default.search({ pageSize: 10, pageIndex: this.page, content: this.searchValue || '最强村医', type: this.type }).then(function (res) {
	            ...
	            _this2.isSeach = true;
	            for (var i in result) {
	                _this2.resultData.push(result[i]);
	            }
	
	            if (_this2.resultData.length == 0) {
	                _this2.hasResult = false;
	            }
	            _this2.$element("search-input").focus({
	                focus: false
	            });
	        });
	    },
	    ...
	    hotsearch: function hotsearch(item) {
