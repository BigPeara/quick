	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {},
	                      "repeat": {
	                        "exp": function () {return this.specialSub},
	                        "value": "item"
	                      },
	                      "children": [
	                        {
	                                      ...
	                                      "children": [
	                                        {
	                                          "type": "text",
	                                          "attr": {
	                                            "value": function () {return this.item.chapterMoney}
	                                          },
	                                          "classList": [
	                                            "money"
	                                          ]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    subscriptionRecordRefresh: function subscriptionRecordRefresh() {
	        var _this = this;
	
	        this.isRefreshing = true;
	        this.hasMoreData = false;
	        this.page = 1;
	        _personData2.default.subscriptionRecord({ pageSize: 10, pageIndex: this.page, type: 2 }).then(function (res) {
	            _this.specialSub = [];
	            ...
	            for (var i in res.data) {
	                _this.specialSub.push(res.data[i]);
	            }
	            _this.isRefreshing = false;
	        });
	    },
	    specialSubRecordRefresh: function specialSubRecordRefresh() {
	        var _this2 = this;
	
	        this.isRefreshing = true;
	        this.hasMoreData = false;
	        this.page = 1;
	        _personData2.default.specialSubRecord({ pageSize: 10, pageIndex: this.page, type: 2 }).then(function (res) {
	            _this2.specialSub = [];
	            if (res.data.length < 10) {
	            ...
	            for (var i in res.data) {
	                _this2.specialSub.push(res.data[i]);
	            }
	            _this2.isRefreshing = false;
	        });
	    },
	    getMoreSpecialSubRecordR: function getMoreSpecialSubRecordR() {
	        var _this3 = this;
	        ...
	        _personData2.default.specialSubRecord({ pageSize: 10, pageIndex: this.page, type: 2 }).then(function (res) {
	            if (res.data.length < 10) {
	                ...
	                _this3.hasMoreData = true;
	            }
	            for (var i in res.data) {
	                _this3.specialSub.push(res.data[i]);
	            }
	            _this3.isRefreshing = false;
	        });
	    },
	    getMoreSubscriptionRecord: function getMoreSubscriptionRecord() {
	        var _this4 = this;
	        ...
	        _personData2.default.subscriptionRecord({ pageSize: 10, pageIndex: this.page, type: 2 }).then(function (res) {
	            ...
	            for (var i in res.data) {
	                _this4.specialSub.push(res.data[i]);
	            }
